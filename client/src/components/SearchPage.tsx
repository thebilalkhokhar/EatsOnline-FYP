            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              ...
              <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                {appliedFilter.map((selectedFilter: string, idx: number) => (
                  ...
                  >
                    <Badge
                      className="text-[#ff5733] rounded-md hover:cursor-pointer pr-6 whitespace-nowrap"
                      variant="outline"
                    >
                      {selectedFilter}
                    </Badge>
                    <X
                      ...
                      size={16}
                      className="absolute text-[#ff5733] right-1 hover:cursor-pointer"
                    />
                  </div>
                ))}
              </div>
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`}>
                        <Button className="bg-[#ff5733] hover:bg-[#e14e2a] text-white font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                          View Menus
                        </Button>
                      </Link>
                    </CardFooter>
