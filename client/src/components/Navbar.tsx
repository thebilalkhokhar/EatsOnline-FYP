                ...
                <MenubarMenu>
                  ...
                  <MenubarContent>
                    ...
                    <Link to="/admin/sales-report">
                      <MenubarItem>Sales Report</MenubarItem>
                    </Link>
                  </MenubarContent>
                </MenubarMenu>
              </Menubar>
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          size="icon"
          variant="outline"
          className="rounded-full bg-[#ff5733] hover:bg-[#e14e2a] text-white shadow-md transition-colors duration-200"
        >
          <Menu size={18} />
        </Button>
      </SheetTrigger>
      <SheetContent className="flex flex-col">
        <SheetHeader className="flex flex-row items-center justify-between mt-2">
          <SheetTitle>🍕 EATSONLINE 🍔</SheetTitle>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="icon">
                <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
        ...
        <SheetFooter className="flex flex-col gap-4">
          <div className="flex flex-row items-center gap-2">
            ...
            <h1 className="font-bold">EATSONLINE</h1>
          </div>
          <SheetClose asChild>
            {loading ? (
              <Button className="bg-orange hover:bg-hoverOrange">
